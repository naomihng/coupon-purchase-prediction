...
test <- distm(dat[,c("coupon_LONGITUDE","coupon_LATITUDE")], dat[,c("user_LONGITUDE","user_LATITUDE")], fun = distHaversine)
```
...
# for decision tree: use matched flag or just leave as two columns?
```
